...
# Taken from https://github.com/gautierdag/pytorch-attentive-lm/blob/master/utils/pre_process_wikitext.py
...
if __name__ == "__main__":
    ...
    valid = "data/corpora/wikitext2/valid.txt"
    test = "data/corpora/wikitext2/test.txt"
